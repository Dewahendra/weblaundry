                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      <a href="{{route('pengguna.create')}}" class="btn btn-primary">Tambah Data<i class=" ml-2 fas fa-plus-square"></i></a>
                                      <br>
                                      <br>
                                  <?php $No=1;?>
                                  @foreach ($pengguna as $item)
                                        <tr>
                                            ...
                                            <form action="{{route('pengguna.destroy', $item->id)}}" method="POST">
                                              ...
                                              @method('DELETE')
                                            <td>
                                            <a href="{{route('pengguna.edit', $item->id)}}" class="btn btn-primary">Edit<i class=" ml-2 fas fa-edit"></i></a>
